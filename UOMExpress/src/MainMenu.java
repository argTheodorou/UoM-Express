//Έχοντας φτάσει στο τέλος της προθεσμίας υποβολής του έργου και κοιτώντας πίσω θα άλλαζα πολλά κομμάτια προγραμματιστικά αλλά η πίεση χρόνου 
//τώρα την περίοδο των εξετάσεων είναι μεγάλη. 
//Σίγουρα θα άλλαζε το μεγαλύτερο μέρος του προγράμματος με περισσότερες κλάσεις. 
//Οι αποστολές θα έπρεπε να είναι αντικείμενα κλάσεων που θα δημιουργόντουσαν από μια κλάση-εντολέα.
//Επίσης τα 2 μεταφορικά μέσα θα τα έκανα δικές τους κλάσεις και θα τα έδινα μεταβλητές οπως space left που εδώ γράφτηκαν αρκετά πολύπλοκα.
//Έτσι θα μπορουσα να χρησιμοποιίσω και μεταβλητή final max_capacity_ship που με 1 αλλαγή ενός νούμερου θα μπορούσα να αναβαθμίσω το μεταφορικό μέσο χωρις να αλλάζω το 
//μέχρι τώρα capacity σε 10 σημεία που εμφανίζεται σε όλο το πρόγραμμα.
